...
scenario="SSP370" 
versiontag="ssp370"
casename="TestM23_ESM2025_${model}_${modelconfig}_${scenario}_${resolution}_$versiontag"
...
usermodsdir="/cluster/work/users/kjetisaa/isimip_forc/$versiontag/$model/user_mods/"
casedir="/cluster/work/users/kjetisaa/ESM2025_noresmhub/cases/$model/"
mkdir -p $casedir

stop_n="2"
stop_opt="nyears"
job_wc_time="01:00:00"
resub="0" 
...
./xmlchange CLM_USRDAT_DIR="/cluster/work/users/kjetisaa/isimip_forc/$versiontag/$model"
